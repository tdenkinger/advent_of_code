defmodule AdventDay2Test do
  ...
  test "figures the amount of ribbon for all packages" do
    {:ok, data} = File.read("../../input/day2_input")
    paper_total = AdventDay2.get_required(:ribbon, data)
